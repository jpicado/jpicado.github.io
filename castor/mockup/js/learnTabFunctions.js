...
$( document ).ready(function() {
	...
	$.getJSON('data/hiv-2k4k/castor-fold1-schema1.json', function(data) {
		// populateStatsForAlgorithmOnSchema("#dummy",json.algorithm,"#dummy",json.schema,"#learnEffectiveness-precision",json.precision,"#learnEffectiveness-recall",json.recall,"#learnEffectiveness-f1",json.f1,"#learnEffectiveness-time",json.time);
		...
		$("#learnEffectiveness-time").html(formatNumber(data.time/60));
	});
});
