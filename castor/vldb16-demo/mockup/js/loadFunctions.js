...
function loadHIVDataset() {
	...
	$.getJSON('data/hiv-large/foil-cl15-fold1-schema1.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm1",json.algorithm,"#graphical-algorithm1-schema1-title",json.schema,"graphical-algorithm1-schema1",json.definition,1,1,"#compareTab-numberOfClauses-algorithm1-schema1");
	});
	// Algorithm 1 - Schema 2
	$.getJSON('data/hiv-large/foil-cl15-fold1-schema2.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm1",json.algorithm,"#graphical-algorithm1-schema2-title",json.schema,"graphical-algorithm1-schema2",json.definition,2,1,"#compareTab-numberOfClauses-algorithm1-schema2");
	});
	// Algorithm 2 - Schema 1
	$.getJSON('data/hiv-large/castor-fold1-schema1.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm2",json.algorithm,"#graphical-algorithm2-schema1-title",json.schema,"graphical-algorithm2-schema1",json.definition,1,2,"#compareTab-numberOfClauses-algorithm2-schema1");
	});
	// Algorithm 2 - Schema 2
	$.getJSON('data/hiv-large/castor-fold1-schema2.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm2",json.algorithm,"#graphical-algorithm2-schema2-title",json.schema,"graphical-algorithm2-schema2",json.definition,2,2,"#compareTab-numberOfClauses-algorithm2-schema2");
	});
	...
	$.getJSON('data/hiv-2k4k/castor-fold1-schema1.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm3",json.algorithm,"#graphical-algorithm3-schema1-title",json.schema,"graphical-algorithm3-schema1",json.definition,1,3,"#compareTab-numberOfClauses-algorithm3-schema1");
	});
	...
	$.getJSON('data/hiv-2k4k/castor-fold1-schema2.json', function(json) {
		...
		populateGraphicalForAlgorithmOnSchema("#graphical-algorithm3",json.algorithm,"#graphical-algorithm3-schema2-title",json.schema,"graphical-algorithm3-schema2",json.definition,2,3,"#compareTab-numberOfClauses-algorithm3-schema2");
	});*/
}
